...
DEVELOPER_HANDBOOK_SECTIONS: tuple[SectionTemplate, ...] = (
    ...
    SectionTemplate(
        ...
        "analysis limitations unsupported patterns generated files truncated omitted evidence",
        purpose="Record limitations of this automated analysis run, not defects of the repository.",
        must_cover=("unsupported patterns", "generated/truncated inputs", "omitted or weak evidence"),
        avoid=("claiming files or APIs are absent from the repository because they were absent from evidence",),
        document_keys=("architecture_map",),
    ),
    SectionTemplate(
        "change_report",
...
GO_LIBRARY_HANDBOOK_SECTIONS: tuple[SectionTemplate, ...] = (
    ...
    SectionTemplate(
        ...
        "Analysis Limitations",
        "analysis limitations unsupported patterns generated files truncated omitted evidence",
        purpose="Record limitations of this automated analysis run, not defects of the Go project.",
        must_cover=("weak or omitted evidence", "generated/truncated inputs", "areas needing manual verification"),
        avoid=(
            "using commit history as current defects",
            "claiming a file/function is absent from the repository because retrieval did not return it",
        ),
        document_keys=("architecture_map",),
    ),
    SectionTemplate(
...
MONOREPO_WEB_APP_HANDBOOK_SECTIONS: tuple[SectionTemplate, ...] = (
    ...
    SectionTemplate(
        ...
        "Analysis Limitations",
        "analysis limitations unsupported patterns generated files truncated omitted evidence",
        purpose="Record limitations of this automated analysis run, not defects of the monorepo.",
        must_cover=("generated/truncated inputs", "unsupported languages/patterns", "manual checks needed"),
        avoid=(
            "treating historical commits as current bugs",
            "claiming repository absence from missing retrieval evidence",
        ),
        document_keys=("architecture_map",),
    ),
    SectionTemplate(
